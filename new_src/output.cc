...
void Output::push_back(const string &str, size_t nsupport, size_t parent_id) {
  support_.push_back(nsupport);
  parent_.push_back(parent_id);
  buffer_.push_back(str);  
}

void Output::push_back(const string &str, size_t nsupport, size_t graph_id, size_t parent_id) {
